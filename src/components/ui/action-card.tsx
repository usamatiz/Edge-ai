                ...
                <div className="bg-[#2F2F2F]/30 backdrop-blur-lg border border-[#D8D8D8]/70 rounded-[24px] px-[44px] py-[26px]">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <Link href="/login" className="px-[26.5px] py-[13.2px] border border-white/30 text-white rounded-full font-semibold hover:bg-white/10 transition-all duration-300">
                                Watch Demo
                            </Link>
                            <Link href="/login" className="px-[28px] py-[13.2px] bg-[#5046E5] text-white rounded-full font-semibold hover:bg-transparent border-[#5046E5] hover:text-white hover:border-white/30 border transition-all duration-300">
                                Get Started
                            </Link>
                        </div>
                    </div>
