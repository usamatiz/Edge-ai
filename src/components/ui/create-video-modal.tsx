...
//       const response = await fetch('/api/create-video/generate-video', {
//         method: 'POST',
//         headers: {
//           'Content-Type': 'application/json',
//         },
...
//       // Check if the response contains videoUrl (multiple possible locations)
//       const videoUrl = result.data?.videoUrl || result.videoUrl || result.data?.url || result.url;
      
//       if (videoUrl) {
//         await handleVideoDownload(videoUrl);
//         setCurrentStep('complete');
//       } else if (result.data && result.data.status === 'processing') {
//         // Video generation started successfully
//         setCurrentStep('loading');
        
//         // Show success message and go to loading state
        
//       } else if (result.success && result.message) {
//         // If we get a success response but no video URL, assume it's processing
//         setCurrentStep('loading');
//       } else {
//         // Unexpected response format - log everything for debugging
...
//                 </p>
//                 <p className="text-[#5046E5] text-sm mb-4">
//                   You can close this window and check back later. The video will be available when ready.
//                 </p>
//               </div>

//               <div className="flex justify-center mb-6 relative">
//                 <div className="loader text-[#5046E5] text-[18px] font-normal absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
...
//                 <p>• Video generation started successfully</p>
//                 <p>• Processing in the background</p>
//                 <p>• You can close this window</p>
//                 <p>• Check back in 10-15 minutes</p>
//               </div>
//             </div>
//           )}
...
export default function CreateVideoModal({ isOpen, onClose, startAtComplete = false, videoData, webhookResponse }: CreateVideoModalProps) {
  ...
  // Auto close modal after 20 seconds when in loading state
  useEffect(() => {
          ...
          {currentStep === 'loading' && (
            <div className="text-center py-12">
              ...
              {/* <div className="text-[#5F5F5F] text-sm">
                ...
                <p>• You can close this window</p>
                <p>• Check back in 10-15 minutes</p>
                <p>• Modal will auto-close in a few seconds</p>
              </div> */}
            </div>
          )}
